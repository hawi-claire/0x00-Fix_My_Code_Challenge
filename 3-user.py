...
class User():
    ...
    def password(self, pwd):
        ...
        if pwd is None or type(pwd) is not str:
            ...
            self._password = hashlib.md5(pwd.encode()).hexdigest().lower() # Fix: use self.__password
    ...
    def is_valid_password(self, pwd):
        ...
        if self.__password is None:
            return False
        return hashlib.md5(pwd.encode()).hexdigest().lower() == self.__password # Fix: use lowercase for comparison
